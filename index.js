...
const instagram = 'https://instagram.com/amirrehan211'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6281256264777'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'gak punya'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'gak punya'; // JANGAN UBAH-UBAH INFO!!!
//ALFBOT
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] CEPET SCAN NYA SOALNYA CUMAN 30 DETIK!`);
});
...
conn.sendMessage(id, ' *Owner ALFBOT wa.me/+6285281968399* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, 'Pengin ngentod? yaudah ayo' ,MessageType.text);
}
else if (text == 'Anjing'){
conn.sendMessage(id, 'Jangan toxic anjing,kntl,babi,monyet' ,MessageType.text);
}
else if (text == 'Bacot'){
conn.sendMessage(id, ' *lu bacot -_-* ' ,MessageType.text);
}
else if (text == 'Test'){
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah ALFBOT
